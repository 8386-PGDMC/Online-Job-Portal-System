...
app.put("/:seeker_id", (request, response) => {
    ...
    let queryText = `update jobseeker set fname = '${fname}', lname ='${lname}',email = '${email}',password ='${password}',contactme='${contactme}',state='${state}',city='${city}',qualification='${request.body.qualification}' where seeker_id=${seeker_id}`;
