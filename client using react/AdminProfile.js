...
function AdminProfile() {
    ...
    useEffect(() => {
        const fetchProfileData = async () => {
            ...
            try {
                ...
                const response = await axios.get(`http://127.0.0.1:9999/jobprovider/adminprofile/${provider_id}`, {
                    headers: {
    ...
    const handleUpdate = async () => {
        try {
            ...
            await axios.put(`http://127.0.0.1:9999/jobprovider/${provider_id}`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
